...
class Brick(pg.sprite.Sprite):
    ...
    def setup_frames(self):
        ...
        self.frames.append(self.get_image(0, 48, 32, 32))
        self.frames.append(self.get_image(96, 16, 32, 32))
    ...
    def opened(self):
        ...
        if self.contents == 'Scarab' and self.powerup_in_box:
            self.group.add(powerups.Scarab(self.rect.centerx, self.rest_height))
...
class BrickPiece(pg.sprite.Sprite):
    ...
    def setup_frames(self):
        ...
        image = self.get_image(64, 16, 16, 16)
