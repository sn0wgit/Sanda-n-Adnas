...
class Coin(pg.sprite.Sprite):
    ...
    def setup_frames(self):
        ...
        self.frames.append(self.get_image(0, 198, 14, 24))
        self.frames.append(self.get_image(14, 198, 14, 24))
        self.frames.append(self.get_image(28, 198, 14, 24))
        self.frames.append(self.get_image(42, 198, 14, 24))
        self.frames.append(self.get_image(56, 198, 14, 24))
        self.frames.append(self.get_image(70, 198, 14, 24))
        self.frames.append(self.get_image(84, 198, 14, 24))
    ...
    def spinning(self):
        ...
        if (self.current_time - self.animation_timer) > 53:
